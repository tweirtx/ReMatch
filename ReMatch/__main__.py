...
def main_rewrite(event_key, event_type, day_one_id, day_one_type, day_two_id, day_two_type, day_three_id, day_three_type):
    day_one_timestamp = timestamp_and_dl(day_one_id, day_one_type, event_key + "_one.mp4")
    day_two_timestamp = timestamp_and_dl(day_two_id, day_two_type, event_key + "_two.mp4")
    day_three_timestamp = timestamp_and_dl(day_three_id, day_three_type, event_key + "_three.mp4")
    if event_type == 'frc':
